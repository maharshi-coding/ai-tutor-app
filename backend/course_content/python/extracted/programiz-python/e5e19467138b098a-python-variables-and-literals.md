...
Original Path: https://www.programiz.com/python-programming/variables-constants-literals
...
In the above example, we assigned the value
programiz.pro
...
Here, the value of site_name is changed from
'programiz.pro'
to
'apple.com'
.
...
Here, we have assigned the same string value
'programiz.com'
to both the variables site1 and site2 .

Rules for Naming Python Variables

1. Constant and variable names should have a combination of letters in lowercase (a to z) or uppercase ( A to Z ) or digits ( 0 to 9 ) or an underscore
( _ )
. For example:
...
Literals are representations of fixed values in a program. They can be numbers, characters, or strings, etc. For example,
'Hello, World!'
,
12
,
...
In the above expression, site_name is a variable, and
'programiz.com'
is a literal.
...
Integer literals are numbers without decimal parts. It also consists of negative numbers. For example,
5
,
-11
,
...
Just like integers, floating-point numbers can also be both positive and negative. For example,
2.5
,
6.76
,
...
Here, numerals are in the form
a + bj
, where
a
is real and
b
is imaginary. For example,
6+9j
,
2+3j
.
...
Here,
True
is a boolean literal assigned to is_pass .
