...
Original URL: https://www.programiz.com/python-programming/list
Original Path: https://www.programiz.com/python-programming/list
...
Here, we have replaced the element at index 0 with
'Purple'
and the element at index 2 with
'Blue'
.
...
remove()
method, we can delete an item from a list using the del statement . The
del
