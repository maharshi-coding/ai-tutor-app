...
Original URL: https://docs.python.org/3/tutorial/venv.html
Original Path: https://docs.python.org/3/tutorial/venv.html
...
the command was run (as reported by the
--version
option).
For instance, executing the command with
python3.12
will install
version 3.12.
