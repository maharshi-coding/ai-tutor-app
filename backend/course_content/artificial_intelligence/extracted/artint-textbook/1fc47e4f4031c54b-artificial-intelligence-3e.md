...
Original URL: https://artint.info/3e/html/ArtInt3e.idx.html
Original Path: https://artint.info/3e/html/ArtInt3e.idx.html
...
heuristic 3rd item , §3.6 , §3.6.3

search algorithm §3.6.1
...
reasoning 2nd item , §14.3.1

aerodynamics §1.2.1

agent §1.1 , §1.3 , §2.1 , §2.1

autonomous §1.3 , Chapter 18

purposive §1.3

semi-autonomous §1.3 , Chapter 18 , §18.3
...
asynchronous value iteration Figure 12.18

boosting Figure 7.19

branch-and-bound

factored optimization Figure 4.12

collaborative filtering Figure 17.2

constraint satisfaction problem (CSP)

domain splitting Figure 4.6

generalized arc consistency Figure 4.4

Conv2D Figure 8.9

debugging

false positive Figure 5.6

missing answer Figure 5.7

decision tree learner Figure 7.9

depth-first

branch-and-bound Figure 3.14

CSP solver Figure 4.1

decision network optimization Figure 12.13

probabilistic inference Figure 9.9

search Figure 3.9

dropout Figure 8.7

expectation maximization (EM) Figure 10.8

game tree search Figure 14.5

genetic algorithm Figure 4.11

crossover 28

Gibbs sampling Figure 9.35

gradient-boosted trees Figure 7.21

iterative deepening Figure 3.11

k -means Figure 10.4

likelihood weighting Figure 9.33

local search Figure 4.8

logistic regression Figure 7.12

minimax with α – β pruning Figure 14.7

model-based reinforcement learning Figure 13.6

neural network

dense linear function Figure 8.3

stochastic gradient descent 15

partial-order planner Figure 6.6

particle filtering Figure 9.34

policy iteration Figure 12.19

proof procedure

conflict

bottom-up Figure 5.9

top-down Figure 5.10

Datalog

top-down Figure 15.5

definite clause

bottom-up Figure 5.3

top-down Figure 5.4

negation-as-failure

bottom-up Figure 5.11

top-down Figure 5.12

Q -learning Figure 13.3

recursive conditioning Figure 9.12

ReLU (neural network) Figure 8.4

SARSA Figure 13.5

with generalization Figure 13.7

with linear function approximation Figure 13.8

generic Figure 3.5

multiple-path pruning Figure 3.16

sigmoid (neural network) 9

stochastic policy iteration Figure 14.10

unification Figure 15.4

value iteration Figure 12.17

variable elimination

belief network Figure 9.13

CSP Figure 4.7

decision network Figure 12.14

single-stage decision network Figure 12.8
...
clause §15.9 , 2nd item

proposition §5.1.1 , 1st item
...
neural network 4th item , 5th item , §18.3 , §8.5.4

to environment §12.5.5
...
information criteria (BIC) §10.2.4 , §10.3.1
...
network §1.2 , §10.4 , §9.3 , §9.3

state §1.3 , §12.5.5 , §2.1.2 , §8.5.2

transition function 2nd item , §2.1.3 , §2.2 , §8.5.2 , 2nd item
...
machine learning §18.2 , item Bias , 1st item , §7.6 , §8.1 , 4th item

bias §10.1

representation 1st item
...
cross-entropy loss §7.2.1

log loss §7.2.1 , 2nd item

variable §4.1.1 , §9.1.1 , §9.2
...
variable §4.1.1 , 1st item , §9.1.1

boosting §7.5.1

algorithm Figure 7.19
...
definite clauses Figure 5.3

negation as failure §5.7.2
...
algorithm Figure 4.12

branch-and-bound search §3.6.2

factored optimization §4.8.1
...
model Chapter 11 , §5.9

network §11.1 , 2nd item
...
function 3rd item , §2.1.3 , §2.2 , §8.5.2

trace §2.1.1

common sense §1.1.1 , §18.3 , §19.3

reasoning §1.6.3 , Example 1.2
...
bottom-up proof procedure item Completeness

knowledge assumption §5.7
...
probability distribution §9.1.2

probability table §9.3.3
...
goal §18.3 , §18.6 , 5th item

hard Chapter 4

initial-state 4th item

network §4.3

precondition 1st item

satisfaction §18.6 , §4.1.3
...
neural network (CNN) §17.3.1 , §8.4 , §8.4 , §8.4 , §9.6.1

relational graph (R-GCN) §17.3.4
...
false negative §5.5.2

false positive §5.5.1

algorithm Figure 5.6

incorrect answers §5.5.1

missing answer §5.5.2 , §5.5.2
...
Markov decision process §12.5

network §12.3.1 , §12.3.1 , 3rd item
...
fake Chapter 18 , §8.6.1 , §8.6.2

learning §1.5.10 , Chapter 8

reinforcement learning §13.9 , 5th item
...
algorithm Figure 4.1

decision network optimization

algorithm Figure 12.13
...
consistency-based §5.6.3

decision-theoretic Example 12.9
...
computational limits §1.5.4

effect uncertainty §1.5.6
...
number of agents §1.5.8

planning horizon §1.5.2

preference §1.5.7

representation §1.5.3

sensing uncertainty §1.5.6
...
time §2.1.1 , §2.3.1 , §9.6.4

variable §4.1.1 , §9.1.1
...
belief network §9.6.4

decision network §12.5.4 , §12.5.4
...
item item Add k latent properties
...
user item Add k latent properties
...
data item Imperfect data

debugging §5.5.1

false negative §5.5.2 , §7.2.3

false positive §5.5.1 , §7.2.3
...
consequentialist 2nd item

deontological 3rd item , §18.7

Kantian 3rd item

utilitarian 2nd item
...
test item Measuring success

training item Task , item Measuring success , 3rd item

validation (dev) §7.4.3
...
algorithm Figure 10.8

expected

monetary value 2nd item

return of policy §12.5.1

sample size §10.5

utility §12.2

decision network §12.3.2
...
extrapolation item Interpolation and extrapolation

f ⁢ ( p ) in A ∗ §3.6.1

facial

characterization 2nd item

detection 1st item

identification 4th item

recognition §18.2 , §18.7 , §18.8 , §7.7

verification 3rd item
...
Markov decision process (MDP) 1st item
...
decision network §14.2.3

extensive form §14.2.2

normal-form §14.2.1

tree §14.2.2

zero-sum 2nd item , §14.3.1

game tree search 4th item

algorithm Figure 14.5
...
adversarial network §1.2 , §8.6.2

AI §1.2 , §19.3 , §8.6.3 , 10th item

image model §8.6.1

language model §8.5.2 , 3rd item , §9.6.6

generic search algorithm §3.4

genetic algorithm §4.7

algorithm Figure 4.11
...
algorithm Figure 7.21

grammar §15.7.1

context-free §15.7.1

definite clause §15.7.1

granularity §9.6.5

graph §3.3.1

neural network §17.3.4
...
Markov model (HMM) 2nd item , §9.6.2

property item Add a latent property

variable §10.3.2 , §10.4.1 , 3rd item

hidden layer §8.1

hierarchical

control 1st item , §19.2 , §2.2
...
item embedding item Add k latent properties
...
k -fold cross validation §7.4.3 , §8.3

k -means §10.3.1

algorithm Figure 10.4
...
base item Step 4 , §5.1.2 , 3rd item
...
definite clause §15.7

probabilistic §17.3.3 , §9.6.6
...
Dirichlet allocation (LDA) 4th item , §17.3.3

property item Add a latent property

tree model 3rd item

variable 3rd item , see hidden variable
...
as search item Learning as search

Bayesian §10.2

belief network §10.4 — §10.4.4

bias §10.1 , item Bias , 1st item

collaborative filtering §17.2.1

decision tree §10.2.3 , §7.3.1

deep Chapter 8

dimension §1.5.5

expectation maximization (EM) §10.3.2 , §10.4.1

k -means §10.3.1

minimum description length §10.2.4

missing data §10.4.2

multiagent §14.7.2

naive Bayes classifier §10.2.2

neural network Chapter 8

probabilistic classifier §10.2.2

probabilities §10.1

rate §7.3.2

reinforcement Chapter 13

relational Chapter 17

stochastic policies §14.7.2

structure §10.4.3

supervised item Feedback

to act Chapter 13

unsupervised §10.3 , item Feedback
...
regression §1.2 , §10.2.2 , §7.3.2 , §9.3.3

relational 2nd item

logistic regression

algorithm Figure 7.12
...
chain Monte Carlo (MCMC) §17.3.2 , §17.4 , §9.7.7

decision process (MDP) §1.2 , §12.5 — §12.5.5 , §13.1 , 3rd item

fully observable 1st item

partially observable (POMDP) 2nd item

hidden Markov model (HMM) §9.6.2

logic network (MLN) §17.3.4
...
factorization item Add k latent properties

multiplication item Add k latent properties , §8.5.1 , §8.5.1 , §9.6.3
...
tree search (MCTS) 2nd item , §9.7.2
...
relational graph convolutional §17.3.4
...
variable Example 17.10 , §9.3.3 , §9.3.3
...
learning item Online and offline
...
computation 2nd item , §2.3.3

gradient descent §7.3.2
...
decision network §12.2.1 , §12.3.2
...
solution item Optimal solution , §3.3.1 , §3.5.4
...
Markov decision process 2nd item , §12.5.5

particle §9.7.6

particle filtering §9.7.6

algorithm Figure 9.34
...
deterministic Chapter 6

forward §6.2

horizon §1.5.2 , §12.5 , §2.2
...
bias item Representation

dimension §1.5.7

elicitation §12.1.2 , §19.3
...
probability §10.1 , §9.1 , §9.1.2 , §9.1.2
...
language model §17.3.3 , §9.6.6

logic model §17.3.1

logic program 1st item , §17.3.4 , §9.3.3

logic programming 1st item

prediction 2nd item

programming 1st item , §9.3.3

relational model , see relational probabilistic model

soft logic (PSL) §17.3.4
...
predicate calculus §15.5

procedure §5.3.2

bottom-up §15.5.2 , §5.3.2

conflict Figure 5.10

Datalog §15.5.2 , §15.5.4

negation-as-failure §5.7.2

top-down §15.5.4 , §5.3.2
...
algorithm Figure 5.10

Datalog

top-down

algorithm Figure 15.5

definite clause

bottom-up

algorithm Figure 5.3

top-down

algorithm Figure 5.4

negation-as-failure

bottom-up

algorithm Figure 5.11

top-down

algorithm Figure 5.12

p ⁢ r ⁢ o ⁢ p Example 16.3
...
algorithm Figure 13.3

qualitative

derivatives 3rd item
...
restart §10.3.1 , 1st item , §4.6 , §4.6.5
...
dependency network §17.3.4

graph convolutional network (R-GCN) §17.3.4

learning Chapter 17 , §7.2

logistic regression 2nd item , §17.3.4

probabilistic model §17.3.1 , §17.3.1

representations 3rd item

uncertainty §17.3.1 , §17.4
...
bias item Representation , 1st item

dimension §1.5.3 , §1.5.3
...
description framework (RDF) §16.3
...
average item Average reward

discounted item Discounted reward
...
algorithm Figure 13.5

with generalization

algorithm Figure 13.7

with linear function approximation §13.9.1

algorithm Figure 13.8
...
bias item Learning as search , 1st item
...
domain splitting §4.4

dynamic programming §3.8.2

for CSPs §4.2

generic

algorithm Figure 3.5

gradient descent §4.8.3

greedy best-first §3.6
...
lowest-cost-first §3.5.4

minimax §14.3.1

multiple-path pruning

algorithm Figure 3.16

policy §13.2

stochastic local §4.6.2
...
natural language item Semantics

predicate calculus §15.3.1

propositional calculus §5.1.2

variables §15.3.2

semi-autonomous §18.3 , §18.3

agent §1.3 , Chapter 18 , §18.3
...
decision problem §12.3

Monte Carlo §9.7.6

prisoner’s dilemma §14.4

probability model §9.6

sequential data §8.5

set item sets

-of-words model §17.3.3 , §9.6.6
...
space graph §3.3.1 , §6.1.1 , §6.2

variable 1st item

stationary

distribution §9.6.1 , §9.7.7

model §12.5 , 3rd item , §9.6.1
...
gradient descent (SGD) §7.3.2

input §9.3.3

local search §4.6.2

policy §14.7.2 , §14.7.2

policy iteration §14.7.2 , 6th item
...
natural language item Syntax

predicate calculus §15.3

propositional calculus §5.1.1
...
user embedding item Add k latent properties
...
Boolean §4.1.1 , 1st item , §9.1.1

continuous §4.1.1

decision §12.2

discrete §4.1.1 , §9.1.1

existentially quantified 2nd item
...
universally quantified 1st item

variable elimination §4.5 , §9.5.2

belief network §9.10 , §9.5.2

algorithm Figure 9.13

CSP §4.5

algorithm Figure 4.7

decision network §12.3.4

algorithm Figure 12.14

single-stage decision network §12.2.1

algorithm Figure 12.8

soft constraints §4.8.1
...
word embedding item Add k latent properties , §8.5.1 , §8.5.1 , §8.5.1
...
ϵ -greedy exploration strategy 2nd item

π (denotation of predicate symbols) 3rd item

π (meaning of atoms) §5.1.2

ϕ (denotation of terms) 2nd item , §15.6
