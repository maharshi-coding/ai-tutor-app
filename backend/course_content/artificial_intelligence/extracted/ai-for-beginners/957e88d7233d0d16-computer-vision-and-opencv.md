...
Original URL: https://github.com/microsoft/AI-For-Beginners/blob/HEAD/lessons/4-ComputerVision/06-IntroCV/OpenCV.ipynb
Original Path: lessons/4-ComputerVision/06-IntroCV/OpenCV.ipynb
...
Output:
```text
<Figure size 21600x14400 with 50 Axes>
```
