...
Original URL: https://inst.eecs.berkeley.edu/~cs188/textbook/hmms/particle-filtering.html
Original Path: https://inst.eecs.berkeley.edu/~cs188/textbook/hmms/particle-filtering.html
...
- The range for \(T_{i+1} = 14\) is \(0 \leq r < 0.1\).

- The range for \(T_{i+1} = 15\) is \(0.1 \leq r < 0.9\).

- The range for \(T_{i+1} = 16\) is \(0.9 \leq r < 1\).
