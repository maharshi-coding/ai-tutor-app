...
Original URL: https://inst.eecs.berkeley.edu/~cs188/textbook/logic/theorem.html
Original Path: https://inst.eecs.berkeley.edu/~cs188/textbook/logic/theorem.html
...
- If our knowledge base contains \(A\) and \(A \Rightarrow B\) we can infer \(B\) ( Modus Ponens ).

- If our knowledge base contains \(A \wedge B\) we can infer \(A\). We can also infer B. ( And-Elimination ).

- If our knowledge base contains \(A\) and \(B\) we can infer \(A \wedge B\) ( Resolution ).
