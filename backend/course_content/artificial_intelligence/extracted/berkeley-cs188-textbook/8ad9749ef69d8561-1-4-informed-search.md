...
Original URL: https://inst.eecs.berkeley.edu/~cs188/textbook/search/informed.html
Original Path: https://inst.eecs.berkeley.edu/~cs188/textbook/search/informed.html
...
In other courses, such as CS70 and CS170, you may have been introduced to “trees” and “graphs” in the graph theory context. Specifically, a tree being a type of graph that satisfies certain constraints (connected and acyclic). This is not the distinction between tree search and graph search that we make in this course.  ↩
