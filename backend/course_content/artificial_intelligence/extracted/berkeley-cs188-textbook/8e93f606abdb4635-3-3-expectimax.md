...
Original URL: https://inst.eecs.berkeley.edu/~cs188/textbook/games/expectimax.html
Original Path: https://inst.eecs.berkeley.edu/~cs188/textbook/games/expectimax.html
...
\[\forall \text{agent-controlled states}, V(s) = \max_{s'\in successors(s)}V(s')\] \[\forall \text{chance states}, V(s) = \sum_{s'\in successors(s)}p(s'|s)V(s')\] \[\forall \text{terminal states}, V(s) = \text{known}\]
