...
Source: AIMA Python
Original URL: https://github.com/aimacode/aima-python/blob/HEAD/notebooks/chapter19/Optimizer and Backpropagation.ipynb
Original Path: notebooks/chapter19/Optimizer and Backpropagation.ipynb
