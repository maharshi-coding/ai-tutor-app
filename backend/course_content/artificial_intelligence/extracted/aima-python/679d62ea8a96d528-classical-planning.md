...
Source: AIMA Python
Original URL: https://github.com/aimacode/aima-python/blob/HEAD/classical_planning_approaches.ipynb
Original Path: classical_planning_approaches.ipynb
...
[0;34m[0m [0;34m"""Expands the graph by a level""
```
...
[0;34m[0m [0mself[0m[0;34m.[0m[0mnext_state_links[0m [0;34m=[0m [0;34m{[0m[0;34m}[0m[0;3
```
...
[0;34m[0m[0;34m[0m
[0;34m[0m [0;32mif[0m [0mcheck[0m[0;34m:[0m[0
```
...
[0;34m[0m [0;32mreturn[0m [0;34m[[0m[0maction[0m [0;32mfor[0m [0maction[0m [0;32min[0m [0mself[0m[0;34m.[0m[0mexpanded_actions[0m [0;32mif[0m [0mall[0m[0;34m([0m[0mpre[0m [0;32min[0m [0mconjuncts[0m[0;34m([0m[0mstate[0m[0;34m)[0m [0;32mfor[0m [0mpre[0m [0;32min[0m [0maction[0m[0;34
```
...
[0;34m - the preconditions are consistent with other sub
```
...
[0;34m[0m[0;34m[0m
[0;34m[0m [0mif_fun[0m[0;34m.[0m[0m__name__[0m [0;34m=[0m [0;34m"if the second argument is "[0m [0;34m+[0m [0mstr[
```
...
[0;34m[0m [0massociate[0m[0;34m([0m[0;34m'&'[0m[0;34m,[0m [0msorted[0m[0;34m([0m[0mset[0m[0;34m([0m[0mfilter[0m[0;34m([0m[0;32mlambda[0m [0mclause[0m[0;34m:[0m [0mcla
```
...
[0;34m[0m [0;32mfor[0m [0mt[0m [0;32min[0m [0mrange[0m[0;34m([0m[0mtime[0m [0;34m+[0m
```
...
[0;34m[0m [0meffect[0m[0;34m=[0m[0;34m'Have(x)'[0m[0;34m,[0
```
