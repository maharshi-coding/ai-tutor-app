...
Original Path: https://fullstackdeeplearning.com/course/2022/lecture-9-ethics/
...
Tech Ethics : ethics that anybody who works in the tech industry
broadly needs to think about.

ML Ethics : what ethics has specifically meant for the ML
industry.

AI Ethics : what ethics might mean in the future where true AGI
exists.
...
Trade-Offs : a conflict between what we want and what others
want.

Humility : a response when we don't know what we want or how to
get it.
...
By getting feedback from users, we maintain alignment between
our system and our users.

When making tradeoffs , we should resolve them in consultation
with users.

Humility means we actually listen to our users because we
...
The tech industry should learn from other disciplines if it wants to
avoid a trust crisis.

We can start by educating ourselves about common deceptive or
...
Black in AI , Diversify
Tech Job Board ,
Women in Data Science ,
and the You Belong in AI
podcast . You can make
...
Emad Mostaque , CEO
of Stability AI , has gone so far
...
Is the model "fair"? Fairness is possible, but requires
trade-offs.

Is the system accountable? Accountability is easier than
interpretability.

Who owns the data? Answer this upfront. Changes are on the way.

Should the system be built at all? Repeatedly ask this and use
it to narrow scope.
...
The first step is to educate yourself on the topic . There are
...
After reading this, consider how to prioritize your actions .
