...
Original Path: jupyter_english/assignments_demo/assignment03_decision_trees_solution.ipynb
...
[Dataset](https://archive.ics.uci.edu/dataset/2/adult) UCI Adult (no need to download it, we have a copy in the course repository): classify people using demographical data - whether they earn more than \$50,000 per year or not.
