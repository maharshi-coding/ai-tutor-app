...
Original Path: jupyter_chinese/topic06-特征工程和特征选择.ipynb
...
Output:
```text
<PIL.Image.Image image mode=RGB size=1024x768 at 0x7FF60D6822B0>
```
...
[2019-05-21 06:16:03] Features: 14/3 -- score: -0.38135327949435743[Parallel(n_jobs=-1)]: Using backend LokyBackend with 2 concurrent wor
