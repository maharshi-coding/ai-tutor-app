...
Original Path: jupyter_chinese/assignments_demo/assignment03-决策树和随机森林分析应用.ipynb
...
[<i class="fa fa-external-link-square" aria-hidden="true"> UCI Adult</i>](https://archive.ics.uci.edu/dataset/2/adult) 人口收入普查数据集前面已经使用过了，其具有以下一些特征：
