...
Original Path: jupyter_chinese/topic02-Python-数据可视化分析.ipynb
...
Output:
```text
<seaborn.axisgrid.FacetGrid at 0x7f59e5895160>
...
Output:
```text
<matplotlib.axes._subplots.AxesSubplot at 0x7f59deef35f8>
...
Output:
```text
<seaborn.axisgrid.FacetGrid at 0x7f59dee89f60>
...
Output:
```text
<matplotlib.axes._subplots.AxesSubplot at 0x7f59deb21550>
...
Output:
```text
<matplotlib.axes._subplots.AxesSubplot at 0x7f59dea5c780>
...
Output:
```text
State AK AL AR AZ CA CO CT DC ... TX UT VA VT WA WI WV WY
Churn ...
...
Output:
```text
<matplotlib.collections.PathCollection at 0x7f59d97f3c50>
...
Output:
```text
<matplotlib.collections.PathCollection at 0x7f59d9768da0>
