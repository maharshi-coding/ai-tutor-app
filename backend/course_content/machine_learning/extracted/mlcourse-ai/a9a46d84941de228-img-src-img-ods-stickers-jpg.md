...
Original Path: jupyter_chinese/topic09-时间序列处理与应用.ipynb
...
Output:
```text
<matplotlib.axes._subplots.AxesSubplot at 0x7fd4e40d0240>
...
Output:
```text
<fbprophet.forecaster.Prophet at 0x7fd4e8681630>
```
